...
var TextArea = props => {
  var {
    ...
    iconPosition
      ...
      restProps = (0, _objectWithoutProperties2.default)(props, ["id", "placeholder", "value", "type", "rows", "cols", "onChange", "onBlur", "error", "errorMessage", "isValid", "disabled", "width", "display", "validationIcon", "iconPosition"]);
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_css.InputWrapper, {
    width: "auto",
    display: display
  }, /*#__PURE__*/_react.default.createElement(_css.TextArea, (0, _extends2.default)({
    id: id,
...
TextArea.propTypes = {
  ...
  iconPosition: _propTypes.default.oneOfType(['inside', 'outside']),
