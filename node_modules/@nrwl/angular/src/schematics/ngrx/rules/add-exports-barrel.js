        ...
        if (options.root != true) {
            ...
            if (!!buffer) {
                ...
                workspace_2.insert(host, indexFilePath, [
                    ...workspace_2.addGlobal(indexSourceFile, indexFilePath, exportBarrels
                    ...
                    ...(exportBarrels
                        ? workspace_2.addGlobal(indexSourceFile, indexFilePath, `export { ${className}Actions, ${className}Feature, ${className}Selectors };`)
                        : []),
                    ...(addModels
