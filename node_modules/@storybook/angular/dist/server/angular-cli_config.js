...
function getAngularCliConfig(dirToSearch) {
    ...
    if (!fs_1.default.existsSync(fname)) {
        node_logger_1.logger.error("Could not find angular.json using " + fname);
        return undefined;
    }
    return JSON.parse(strip_json_comments_1.default(fs_1.default.readFileSync(fname, 'utf8')));
}
