...
function updateTsConfig(options) {
    return (host) => {
        ...
        return workspace_1.updateJsonInTree(core_1.join(projectConfig.root, 'tsconfig.json'), (json) => {
            return Object.assign(Object.assign({}, json), { compilerOptions: Object.assign(Object.assign({}, json.compilerOptions), { types: Array.from(new Set([...(json.compilerOptions.types || []), 'jasmine'])) }) });
        });
    };
}
